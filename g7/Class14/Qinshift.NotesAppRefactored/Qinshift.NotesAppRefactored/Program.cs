...
builder.Host.UseSerilog((ctx, lc) => lc.WriteTo.File("loggings.txt"));
...
//added http client in the application pipeline for the fruit service
...
//we need to add this so we can use the views
app.UseStaticFiles();
